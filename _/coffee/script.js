...
(function() {
  ...
  Presenter = (function() {
    ...
    Presenter.prototype.init = function() {
      ...
      $(".nav-item-settings").click(function(e) {
        e.preventDefault();
        $('.header-icon-menu').click;
    ...
    Presenter.prototype.generateNav = function() {
      var indexReference, key, note, presentation, processedPresentations, titleRegEx, _i, _len;
      processedPresentations = {
        list: []
      };
      for (presentation = _i = 0, _len = presentations.length; _i < _len; presentation = ++_i) {
        key = presentations[presentation];
    ...
    Presenter.prototype.listenForKeyEvents = function() {
      if (document.addEventListener) {
        return document.addEventListener('keydown', presenter.keyEventHandler, false);
      } else if (document.attachEvent) {
        return document.attachEvent('keydown', presenter.keyEventHandler);
      }
    };
    ...
    Presenter.prototype.router = function(e) {
      ...
      if (!presentation) {
        ...
        console.log('saw nothing', hash, this.status);
      }
